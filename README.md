...
[![运行级可用](https://img.shields.io/badge/运行级可用_8717-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1489-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_3379-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260916T003001Z`（2026-09-16 08:30:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 21350 · 龄 193m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    C1 --> D1{"判定 · 总 13460"}
    D1 -->|"8717 / 3379"| E1["聚合 + README 分类统计"]
    D1 -->|"1364 环境类重试"| C1
...
- **🔌 Web UI 增强**（2782）— 可用 1302 · 不兼容 449 · 待定 251 · 未测 17 · 监测 763 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2167）— 可用 888 · 不兼容 392 · 待定 203 · 未测 21 · 监测 663 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2291）— 可用 795 · 不兼容 313 · 待定 181 · 未测 13 · 监测 989 — [明细](catalog/all/Agent%20能力.md)
...
- **🛠 基建部署**（1369）— 可用 430 · 不兼容 148 · 待定 127 · 未测 6 · 监测 658 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（159）— 可用 37 · 不兼容 11 · 待定 7 · 未测 2 · 监测 102 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7304）— 可用 1840 · 不兼容 417 · 待定 251 · 未测 21 · 监测 4775 — [明细](catalog/all/其他.md)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260916T003001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

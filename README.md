...
[![confirmed](https://img.shields.io/badge/confirmed-1308-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13486-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8704-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1480-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_3426-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8704-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![to test](https://img.shields.io/badge/to_test_1480-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![needs adapt](https://img.shields.io/badge/needs_adapt_3426-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
## 工作原理
> 数据截至快照 `20260916T211501Z`（2026-09-17 05:15:03 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260916T211501Z` (2026-09-17 05:15:03 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 21532 · 龄 435m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 1308"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13486"}
    D1 -->|"8704 / 3426"| E1["聚合 + README 分类统计"]
    D1 -->|"1356 环境类重试"| C1
...
> 人工策展 55 款插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-09-18 01:07（UTC+8）。
> *Human-curated 55 plugins in 11 groups, star-sorted within each; stars auto-refresh every 6 hours (membership via PR to data/awesome-50.json). As of 2026-09-18 01:07 (UTC+8).*

### 🚀 智力增强 Booster（7）
*Intelligence Boosters (7)*

- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite)** · 7192★ — 注入器 × 思维模式路由套装：免重启运行时注入器 + 任务感知推理模式路由预设（P1-P23 实测）
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[ouroboros](https://github.com/Q00/ouroboros)** · 6000★ — Agent OS：agent 自我变强、人只守底线——自进化运行时（5.7k★；rc.8 实测 ✅）
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[superpowers-dsh](https://github.com/LayneChai/superpowers-dsh)** · 90★ — TDD/调试/计划等开发技能集
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui)** · 7688★ — Web UI 增强与皮肤合集：任务看板、Git 图、移动端、皮肤中心
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar)** · 3641★ — 侧边栏变完整工作台：文件编辑/终端/Git/子代理，支持三方注册扩展页
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-genui](https://github.com/omdsh-dev/dsh-genui)** · 463★ — GenUI 内联组件：图表/表单/测验/3D 场景 + action 事件环
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-annotation](https://github.com/omdsh-dev/dsh-annotation)** · 122★ — 划选文字→批注→随消息发送，回复逐条对照
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-desktop](https://github.com/anywhere-labs/dsh-desktop)** · 27333★ — 生态最高星桌面客户端（21.5k★，原 deepseek-harness-desktop 再改名）：万物皆插件、桌面本身也是插件（雷达重测中；rc.8 源码路径实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop)** · 2209★ — Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui)** · 278★ — 自研 ANSI 渲染的极简终端 UI

### 👁 视觉与多模态（4）
*Vision & Multimodal (4)*

- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[modlens](https://github.com/liustack/modlens)** · 3980★ — 生态第一个视觉插件，视觉工作流的基准方案
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-vision-router](https://github.com/ysr666/dsh-vision-router)** · 1106★ — 内置免费视觉模型路由，给文本 agent 装眼睛
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[distilly](https://github.com/titanwings/distilly)** · 24824★ — 把专家思维蒸馏为可复用 Skills 的平台（24k★，Agent 域之最，原名 colleague-skill；雷达判可用）
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams)** · 1715★ — 多代理团队编排
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[rea](https://github.com/morluto/rea)** · 411★ — 用 agent 逆向工程任何东西：从应用行为到原生二进制
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[open-record-replay](https://github.com/humblebanana/open-record-replay)** · 144★ — macOS 录制回放：把鼠标/键盘/UI 事件存为结构化轨迹供 agent 学习重放
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[axern](https://github.com/cofy-x/axern)** · 66★ — AI agent 开源沙箱：不可信代码执行与持久服务

### 💻 编码与生产力（5）
*Coding & Productivity (5)*

- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[TokenTracker](https://github.com/xiufengsun/TokenTracker)** · 1648★ — 本地优先的 31 种编码工具 token 用量与成本追踪
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[api-relay-audit](https://github.com/toby-bridges/api-relay-audit)** · 839★ — AI API 中继/LLM 代理本地安全审计，产出 Markdown 报告（rc.8 实测 ✅）
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-remote](https://github.com/flymysql/dsh-remote)** · 83★ — 多机远程工作区：SSH 连接管理、远程目录→本地镜像→原生工作区收养、SFTP 双向同步与 rw_* 工具族

### 🧠 记忆与上下文（3）
*Memory & Context (3)*

- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[EverOS](https://github.com/EverMind-AI/EverOS)** · 13025★ — 全 agent 便携记忆层：本地优先、Markdown-native（12.4k★ 记忆域之最；rc.8 实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[mnemon](https://github.com/mnemon-dev/mnemon)** · 586★ — 跨 agent、本地优先的持久记忆
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve)** · 315★ — 五轨记忆 + git 分支托管 + 后台自我进化
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-browser](https://github.com/Lum1104/dsh-browser)** · 677★ — Chrome 侧栏扩展，让 DSH 直接操作浏览器
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-openpencil](https://github.com/ZSeven-W/dsh-openpencil)** · 173★ — OpenPencil 设计稿预览与编辑
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-web-search-pro](https://github.com/anweat/dsh-web-search-pro)** · 66★ — 增强型持久网页搜索
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-market](https://github.com/dsh-market/dsh-market)** · 4080★ — 持续收录 1000+ 插件的市场：中文搜索 + 五维评分
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-plugin-check](https://github.com/omdsh-dev/dsh-plugin-check)** · 26★ — 插件健康检查：清单协议/patch 格式/构建陷阱
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[petdex](https://github.com/crafter-station/petdex)** · 4122★ — 生态最高星桌宠图鉴
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale)** · 2114★ — 深海鲸鱼养成
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[openpets](https://github.com/alvinunreal/openpets)** · 1204★ — 本地优先桌面伴侣平台：动画宠物 + 插件 SDK（娱乐域第二位）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-ads](https://github.com/Nagi-ovo/dsh-ads)** · 627★ — 把 DSH 变回 2005 门户网站：怀旧广告/小游戏/弹窗
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[whale-girl](https://github.com/vlln/whale-girl)** · 325★ — QQ 宠物形态桌宠：可拖拽/投喂/玩耍
...
> 人工策展 16 个整合包：内测成员作品置顶，其下按预设套件 / 能力合集 / 发行版 / 配方管理器四形态分组，类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/bundles.json）。数据截至 2026-09-18 01:07（UTC+8）。
> *Human-curated 16 bundles: insider picks pinned on top, then presets / collections / distributions / recipe managers, star-sorted; auto-refreshed every 6 hours. As of 2026-09-18 01:07 (UTC+8).*
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite)** · 7192★ — 注入器 × 思维模式路由套装：免重启运行时注入器 + P1-P23 任务感知推理模式路由（rc.8 实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard)** · 3813★ — 两阶段预设：极简模式对齐启动 → 全量装载（rc.8 实测 ✅）
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[Aegis](https://github.com/GanyuanRan/Aegis)** · 1206★ — 软件工程方法论技能包：baseline-first 规划、系统性重构（rc.8 实测 ✅）
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[DeepSec](https://github.com/Unclecheng-li/DeepSec)** · 432★ — AI 安全攻防一体化合集：Android · Web · Native · 协议 · 恶意代码 · AI 六域
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill)** · 146★ — 完整逆向工程技能合集（85 个 SKILL.md）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[superpowers-dsh](https://github.com/LayneChai/superpowers-dsh)** · 90★ — TDD/调试/计划等开发技能集（rc.8 实测 ✅）
...
- **🧠 记忆增强**（47）— 可用 14 · 不兼容 5 · 待定 5 · 未测 2 · 监测 21 — [明细](catalog/all/记忆增强.md)
- **🎨 主题皮肤**（25）— 可用 12 · 不兼容 1 · 待定 2 · 未测 7 · 监测 3 — [明细](catalog/all/主题皮肤.md)
- **🛒 市场与管理**（316）— 可用 96 · 不兼容 24 · 待定 22 · 未测 10 · 监测 164 — [明细](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（2791）— 可用 1303 · 不兼容 454 · 待定 253 · 未测 17 · 监测 764 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2166）— 可用 882 · 不兼容 399 · 待定 202 · 未测 20 · 监测 663 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2295）— 可用 794 · 不兼容 317 · 待定 181 · 未测 13 · 监测 990 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（731）— 可用 250 · 不兼容 132 · 待定 55 · 未测 5 · 监测 289 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（691）— 可用 275 · 不兼容 104 · 待定 57 · 未测 9 · 监测 246 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（457）— 可用 169 · 不兼容 39 · 待定 34 · 未测 0 · 监测 215 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1370）— 可用 429 · 不兼容 149 · 待定 127 · 未测 6 · 监测 659 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（159）— 可用 36 · 不兼容 12 · 待定 7 · 未测 2 · 监测 102 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7311）— 可用 1840 · 不兼容 422 · 待定 250 · 未测 21 · 监测 4778 — [明细](catalog/all/其他.md)
...
| 运行级实测 | 8704 可用 · 3426 不兼容 · 1356 待定（共 13486 个，k8s agent 口径）|

...
[![runtime OK](https://img.shields.io/badge/runtime_OK_8563-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![to test](https://img.shields.io/badge/to_test_1610-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![needs adapt](https://img.shields.io/badge/needs_adapt_3482-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
## 工作原理
> 数据截至快照 `20260918T213001Z`（2026-09-19 05:30:03 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260918T213001Z` (2026-09-19 05:30:03 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 22121 · 龄 14m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    C1 --> D1{"判定 · 总 13519"}
    D1 -->|"8563 / 3482"| E1["聚合 + README 分类统计"]
    D1 -->|"1474 环境类重试"| C1
...
- **🔌 Web UI 增强**（2833）— 可用 1311 · 不兼容 504 · 待定 204 · 未测 18 · 监测 796 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2207）— 可用 886 · 不兼容 430 · 待定 166 · 未测 23 · 监测 702 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2351）— 可用 801 · 不兼容 364 · 待定 139 · 未测 14 · 监测 1033 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（749）— 可用 248 · 不兼容 141 · 待定 48 · 未测 6 · 监测 306 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（701）— 可用 271 · 不兼容 115 · 待定 50 · 未测 9 · 监测 256 — [明细](catalog/all/文件数据.md)
...
- **📚 学习研究**（165）— 可用 34 · 不兼容 13 · 待定 8 · 未测 2 · 监测 108 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7534）— 可用 1836 · 不兼容 446 · 待定 230 · 未测 23 · 监测 4999 — [明细](catalog/all/其他.md)
...
| 运行级实测 | 8563 可用 · 3482 不兼容 · 1474 待定（共 13519 个，k8s agent 口径）|

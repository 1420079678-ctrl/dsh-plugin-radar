...
[![confirmed](https://img.shields.io/badge/confirmed-1330-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13523-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)
...
| **累计 / cumulative** | **8529** | **3438** | **1692** | **13659** |
...
## 工作原理
> 数据截至快照 `20260919T071501Z`（2026-09-19 15:15:03 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260919T071501Z` (2026-09-19 15:15:03 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 21991 · 龄 109m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 1330"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13523"}
    D1 -->|"8529 / 3438"| E1["聚合 + README 分类统计"]
    D1 -->|"1556 环境类重试"| C1
...
> 人工策展 55 款插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-09-19 12:44（UTC+8）。
> *Human-curated 55 plugins in 11 groups, star-sorted within each; stars auto-refresh every 6 hours (membership via PR to data/awesome-50.json). As of 2026-09-19 12:44 (UTC+8).*
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[ouroboros](https://github.com/Q00/ouroboros)** · 6033★ — Agent OS：agent 自我变强、人只守底线——自进化运行时（5.7k★；rc.8 实测 ✅）
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui)** · 7756★ — Web UI 增强与皮肤合集：任务看板、Git 图、移动端、皮肤中心
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar)** · 3664★ — 侧边栏变完整工作台：文件编辑/终端/Git/子代理，支持三方注册扩展页
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-desktop](https://github.com/anywhere-labs/dsh-desktop)** · 27617★ — 生态最高星桌面客户端（21.5k★，原 deepseek-harness-desktop 再改名）：万物皆插件、桌面本身也是插件（雷达重测中；rc.8 源码路径实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop)** · 2283★ — Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-vision-router](https://github.com/ysr666/dsh-vision-router)** · 1109★ — 内置免费视觉模型路由，给文本 agent 装眼睛
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[distilly](https://github.com/titanwings/distilly)** · 24870★ — 把专家思维蒸馏为可复用 Skills 的平台（24k★，Agent 域之最，原名 colleague-skill；雷达判可用）
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams)** · 1726★ — 多代理团队编排
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[TokenTracker](https://github.com/xiufengsun/TokenTracker)** · 1662★ — 本地优先的 31 种编码工具 token 用量与成本追踪
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[EverOS](https://github.com/EverMind-AI/EverOS)** · 13059★ — 全 agent 便携记忆层：本地优先、Markdown-native（12.4k★ 记忆域之最；rc.8 实测 ✅）
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve)** · 320★ — 五轨记忆 + git 分支托管 + 后台自我进化
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-browser](https://github.com/Lum1104/dsh-browser)** · 690★ — Chrome 侧栏扩展，让 DSH 直接操作浏览器
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-market](https://github.com/dsh-market/dsh-market)** · 4154★ — 持续收录 1000+ 插件的市场：中文搜索 + 五维评分
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale)** · 2133★ — 深海鲸鱼养成
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[openpets](https://github.com/alvinunreal/openpets)** · 1212★ — 本地优先桌面伴侣平台：动画宠物 + 插件 SDK（娱乐域第二位）
...
> 人工策展 16 个整合包：内测成员作品置顶，其下按预设套件 / 能力合集 / 发行版 / 配方管理器四形态分组，类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/bundles.json）。数据截至 2026-09-19 12:44（UTC+8）。
> *Human-curated 16 bundles: insider picks pinned on top, then presets / collections / distributions / recipe managers, star-sorted; auto-refreshed every 6 hours. As of 2026-09-19 12:44 (UTC+8).*
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill)** · 150★ — 完整逆向工程技能合集（85 个 SKILL.md）
...
- **🎓 技能包**（32）— 可用 7 · 不兼容 3 · 待定 6 · 未测 13 · 监测 3 — [明细](catalog/all/技能包.md)
- **🧠 记忆增强**（47）— 可用 14 · 不兼容 5 · 待定 4 · 未测 2 · 监测 22 — [明细](catalog/all/记忆增强.md)
...
- **🔌 Web UI 增强**（2829）— 可用 1307 · 不兼容 496 · 待定 212 · 未测 18 · 监测 796 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2207）— 可用 884 · 不兼容 427 · 待定 171 · 未测 23 · 监测 702 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2358）— 可用 804 · 不兼容 359 · 待定 148 · 未测 14 · 监测 1033 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（748）— 可用 247 · 不兼容 140 · 待定 49 · 未测 6 · 监测 306 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（701）— 可用 269 · 不兼容 115 · 待定 52 · 未测 9 · 监测 256 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（462）— 可用 172 · 不兼容 49 · 待定 22 · 未测 0 · 监测 219 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1396）— 可用 426 · 不兼容 167 · 待定 117 · 未测 7 · 监测 679 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（166）— 可用 34 · 不兼容 14 · 待定 7 · 未测 2 · 监测 109 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7531）— 可用 1829 · 不兼容 441 · 待定 237 · 未测 23 · 监测 5001 — [明细](catalog/all/其他.md)
...
> 渲染于快照 20260919T071501Z（2026-09-19 15:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）
...
| 运行级实测 | 8529 可用 · 3438 不兼容 · 1556 待定（共 13523 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-1256-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13404-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8910-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1678-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2941-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260914T211501Z`（2026-09-15 05:15:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 21080 · 龄 224m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 1256"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13404"}
    D1 -->|"8910 / 2941"| E1["聚合 + README 分类统计"]
    D1 -->|"1553 环境类重试"| C1
...
- **🎨 主题皮肤**（23）— 可用 11 · 不兼容 0 · 待定 2 · 未测 7 · 监测 3 — [明细](catalog/all/主题皮肤.md)
- **🛒 市场与管理**（316）— 可用 102 · 不兼容 21 · 待定 18 · 未测 10 · 监测 165 — [明细](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（2774）— 可用 1337 · 不兼容 417 · 待定 240 · 未测 17 · 监测 763 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2154）— 可用 911 · 不兼容 362 · 待定 199 · 未测 21 · 监测 661 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2287）— 可用 819 · 不兼容 289 · 待定 178 · 未测 13 · 监测 988 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（726）— 可用 255 · 不兼容 120 · 待定 58 · 未测 5 · 监测 288 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（682）— 可用 274 · 不兼容 95 · 待定 58 · 未测 9 · 监测 246 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（457）— 可用 173 · 不兼容 36 · 待定 33 · 未测 0 · 监测 215 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1370）— 可用 445 · 不兼容 132 · 待定 131 · 未测 6 · 监测 656 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（159）— 可用 39 · 不兼容 8 · 待定 8 · 未测 2 · 监测 102 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7275）— 可用 1858 · 不兼容 384 · 待定 252 · 未测 21 · 监测 4760 — [明细](catalog/all/其他.md)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260914T211501Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

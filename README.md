...
[![confirmed](https://img.shields.io/badge/confirmed-1310-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13498-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8661-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1445-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_3516-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8661-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![to test](https://img.shields.io/badge/to_test_1445-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![needs adapt](https://img.shields.io/badge/needs_adapt_3516-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
## 工作原理
> 数据截至快照 `20260917T210001Z`（2026-09-18 05:00:03 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260917T210001Z` (2026-09-18 05:00:03 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 21870 · 龄 203m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    C1 --> D1{"判定 · 总 13498"}
    D1 -->|"8661 / 3516"| E1["聚合 + README 分类统计"]
    D1 -->|"1321 环境类重试"| C1
...
- **🔌 Web UI 增强**（2791）— 可用 1296 · 不兼容 466 · 待定 248 · 未测 17 · 监测 764 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2170）— 可用 883 · 不兼容 403 · 待定 200 · 未测 20 · 监测 664 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2299）— 可用 792 · 不兼容 327 · 待定 177 · 未测 13 · 监测 990 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（731）— 可用 245 · 不兼容 138 · 待定 54 · 未测 5 · 监测 289 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（691）— 可用 273 · 不兼容 106 · 待定 57 · 未测 9 · 监测 246 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（458）— 可用 169 · 不兼容 41 · 待定 33 · 未测 0 · 监测 215 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1374）— 可用 429 · 不兼容 155 · 待定 124 · 未测 6 · 监测 660 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（159）— 可用 34 · 不兼容 13 · 待定 8 · 未测 2 · 监测 102 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7308）— 可用 1833 · 不兼容 425 · 待定 252 · 未测 21 · 监测 4777 — [明细](catalog/all/其他.md)
...
| 运行级实测 | 8661 可用 · 3516 不兼容 · 1321 待定（共 13498 个，k8s agent 口径）|

...
[![runtime OK](https://img.shields.io/badge/runtime_OK_8671-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![to test](https://img.shields.io/badge/to_test_1679-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![needs adapt](https://img.shields.io/badge/needs_adapt_3490-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
## 工作原理
> 数据截至快照 `20260918T064520Z`（2026-09-18 14:45:21 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260918T064520Z` (2026-09-18 14:45:21 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    ...
    C1 --> D1{"判定 · 总 13488"}
    D1 -->|"8671 / 3490"| E1["聚合 + README 分类统计"]
    D1 -->|"1327 环境类重试"| C1
...
> 人工策展 55 款插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-09-19 00:31（UTC+8）。
> *Human-curated 55 plugins in 11 groups, star-sorted within each; stars auto-refresh every 6 hours (membership via PR to data/awesome-50.json). As of 2026-09-19 00:31 (UTC+8).*

### 🚀 智力增强 Booster（7）
*Intelligence Boosters (7)*

- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite)** · 7195★ — 注入器 × 思维模式路由套装：免重启运行时注入器 + 任务感知推理模式路由预设（P1-P23 实测）
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[ouroboros](https://github.com/Q00/ouroboros)** · 6026★ — Agent OS：agent 自我变强、人只守底线——自进化运行时（5.7k★；rc.8 实测 ✅）
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-web-ui](https://github.com/zhu1090093659/dsh-web-ui)** · 7742★ — Web UI 增强与皮肤合集：任务看板、Git 图、移动端、皮肤中心
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[DSH-better-sidebar](https://github.com/omdsh-dev/DSH-better-sidebar)** · 3659★ — 侧边栏变完整工作台：文件编辑/终端/Git/子代理，支持三方注册扩展页
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-annotation](https://github.com/omdsh-dev/dsh-annotation)** · 123★ — 划选文字→批注→随消息发送，回复逐条对照
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-desktop](https://github.com/anywhere-labs/dsh-desktop)** · 27568★ — 生态最高星桌面客户端（21.5k★，原 deepseek-harness-desktop 再改名）：万物皆插件、桌面本身也是插件（雷达重测中；rc.8 源码路径实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[deepseek-harness-desktop](https://github.com/hairyf/deepseek-harness-desktop)** · 2263★ — Tauri 桌面版：5MB 安装包零环境配置，Win/macOS/Linux
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-tianshu-tui](https://github.com/huiliyi37/dsh-tianshu-tui)** · 280★ — 自研 ANSI 渲染的极简终端 UI

### 👁 视觉与多模态（4）
*Vision & Multimodal (4)*

- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[modlens](https://github.com/liustack/modlens)** · 3985★ — 生态第一个视觉插件，视觉工作流的基准方案
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-vision-router](https://github.com/ysr666/dsh-vision-router)** · 1108★ — 内置免费视觉模型路由，给文本 agent 装眼睛
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[distilly](https://github.com/titanwings/distilly)** · 24858★ — 把专家思维蒸馏为可复用 Skills 的平台（24k★，Agent 域之最，原名 colleague-skill；雷达判可用）
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-agent-teams](https://github.com/NanmiCoder/dsh-agent-teams)** · 1723★ — 多代理团队编排
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[sandbase-harness](https://github.com/sandbaseai/sandbase-harness)** · 646★ — CMA 兼容开源 agent 运行时，任意模型可驱动
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[axern](https://github.com/cofy-x/axern)** · 67★ — AI agent 开源沙箱：不可信代码执行与持久服务

### 💻 编码与生产力（5）
*Coding & Productivity (5)*

- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[TokenTracker](https://github.com/xiufengsun/TokenTracker)** · 1660★ — 本地优先的 31 种编码工具 token 用量与成本追踪
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[api-relay-audit](https://github.com/toby-bridges/api-relay-audit)** · 838★ — AI API 中继/LLM 代理本地安全审计，产出 Markdown 报告（rc.8 实测 ✅）
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-remote](https://github.com/flymysql/dsh-remote)** · 85★ — 多机远程工作区：SSH 连接管理、远程目录→本地镜像→原生工作区收养、SFTP 双向同步与 rw_* 工具族

### 🧠 记忆与上下文（3）
*Memory & Context (3)*

- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[EverOS](https://github.com/EverMind-AI/EverOS)** · 13048★ — 全 agent 便携记忆层：本地优先、Markdown-native（12.4k★ 记忆域之最；rc.8 实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[mnemon](https://github.com/mnemon-dev/mnemon)** · 587★ — 跨 agent、本地优先的持久记忆
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-memory-evolve](https://github.com/csyangwen/dsh-memory-evolve)** · 318★ — 五轨记忆 + git 分支托管 + 后台自我进化
...
- <img src="assets/tile-adapt.svg" alt="需适配" width="122" height="20"> **[dsh-browser](https://github.com/Lum1104/dsh-browser)** · 688★ — Chrome 侧栏扩展，让 DSH 直接操作浏览器
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-web-search-pro](https://github.com/anweat/dsh-web-search-pro)** · 67★ — 增强型持久网页搜索
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-market](https://github.com/dsh-market/dsh-market)** · 4137★ — 持续收录 1000+ 插件的市场：中文搜索 + 五维评分
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[petdex](https://github.com/crafter-station/petdex)** · 4129★ — 生态最高星桌宠图鉴
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-deep-whale](https://github.com/Small-tailqwq/dsh-deep-whale)** · 2128★ — 深海鲸鱼养成
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[openpets](https://github.com/alvinunreal/openpets)** · 1211★ — 本地优先桌面伴侣平台：动画宠物 + 插件 SDK（娱乐域第二位）
...
> 人工策展 16 个整合包：内测成员作品置顶，其下按预设套件 / 能力合集 / 发行版 / 配方管理器四形态分组，类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/bundles.json）。数据截至 2026-09-19 00:31（UTC+8）。
> *Human-curated 16 bundles: insider picks pinned on top, then presets / collections / distributions / recipe managers, star-sorted; auto-refreshed every 6 hours. As of 2026-09-19 00:31 (UTC+8).*
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-routing-suite](https://github.com/yjh051108/dsh-routing-suite)** · 7195★ — 注入器 × 思维模式路由套装：免重启运行时注入器 + P1-P23 任务感知推理模式路由（rc.8 实测 ✅）
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[dsh-anchored-standard](https://github.com/xiaobright/dsh-anchored-standard)** · 3810★ — 两阶段预设：极简模式对齐启动 → 全量装载（rc.8 实测 ✅）
...
- <img src="assets/tile-ok.svg" alt="已兼容" width="122" height="20"> **[Aegis](https://github.com/GanyuanRan/Aegis)** · 1210★ — 软件工程方法论技能包：baseline-first 规划、系统性重构（rc.8 实测 ✅）
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[DeepSec](https://github.com/Unclecheng-li/DeepSec)** · 434★ — AI 安全攻防一体化合集：Android · Web · Native · 协议 · 恶意代码 · AI 六域
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-reverse-skill](https://github.com/dhicoc/dsh-reverse-skill)** · 147★ — 完整逆向工程技能合集（85 个 SKILL.md）
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-daily-kit](https://github.com/zhouwei713/dsh-daily-kit)** · 1★ — 日常插件集合：16 插件 monorepo + 4 bundle，含 596 单测
...
- **🎓 技能包**（16）— 可用 0 · 不兼容 0 · 待定 0 · 未测 16 · 监测 0 — [明细](catalog/all/技能包.md)
- **🧠 记忆增强**（51）— 可用 4 · 不兼容 3 · 待定 1 · 未测 3 · 监测 40 — [明细](catalog/all/记忆增强.md)
- **🎨 主题皮肤**（17）— 可用 6 · 不兼容 0 · 待定 0 · 未测 7 · 监测 4 — [明细](catalog/all/主题皮肤.md)
- **🛒 市场与管理**（409）— 可用 78 · 不兼容 24 · 待定 13 · 未测 16 · 监测 278 — [明细](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（3340）— 可用 1319 · 不兼容 500 · 待定 212 · 未测 56 · 监测 1253 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2652）— 可用 890 · 不兼容 425 · 待定 144 · 未测 69 · 监测 1124 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2750）— 可用 750 · 不兼容 339 · 待定 117 · 未测 53 · 监测 1491 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（932）— 可用 245 · 不兼容 134 · 待定 40 · 未测 22 · 监测 491 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（855）— 可用 268 · 不兼容 116 · 待定 42 · 未测 17 · 监测 412 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（577）— 可用 157 · 不兼容 45 · 待定 22 · 未测 4 · 监测 349 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1798）— 可用 363 · 不兼容 137 · 待定 89 · 未测 22 · 监测 1187 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（217）— 可用 30 · 不兼容 13 · 待定 5 · 未测 3 · 监测 166 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（9735）— 可用 1633 · 不兼容 366 · 待定 155 · 未测 64 · 监测 7517 — [明细](catalog/all/其他.md)
...
| 运行级实测 | 8671 可用 · 3490 不兼容 · 1327 待定（共 13488 个，k8s agent 口径）|

...
## 工作原理
> 数据截至快照 `20260922T071501Z`（2026-09-22 15:15:03 UTC+8 · 分类器 unified-v2-bridge）
> *Data as of snapshot — currently `20260922T071501Z` (2026-09-22 15:15:03 UTC+8 · classifier unified-v2-bridge)*
*How It Works*
...
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 22875 · 龄 364m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 1338"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
...
> 人工策展 55 款插件，按 11 类分组、类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/awesome-50.json）。数据截至 2026-09-22 19:48（UTC+8）。
> *Human-curated 55 plugins in 11 groups, star-sorted within each; stars auto-refresh every 6 hours (membership via PR to data/awesome-50.json). As of 2026-09-22 19:48 (UTC+8).*
...
- <img src="assets/tile-test.svg" alt="待测试" width="122" height="20"> **[dsh-desktop](https://github.com/anywhere-labs/dsh-desktop)** · 28439★ — 生态最高星桌面客户端（21.5k★，原 deepseek-harness-desktop 再改名）：万物皆插件、桌面本身也是插件（雷达重测中；rc.8 源码路径实测 ✅）
...
> 人工策展 16 个整合包：内测成员作品置顶，其下按预设套件 / 能力合集 / 发行版 / 配方管理器四形态分组，类内按星标排序；星标每 6 小时自动刷新（成员调整请提 PR 修改 data/bundles.json）。数据截至 2026-09-22 19:48（UTC+8）。
> *Human-curated 16 bundles: insider picks pinned on top, then presets / collections / distributions / recipe managers, star-sorted; auto-refreshed every 6 hours. As of 2026-09-22 19:48 (UTC+8).*
...
- **🔌 Web UI 增强**（2831）— 可用 1287 · 不兼容 480 · 待定 249 · 未测 18 · 监测 797 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2216）— 可用 872 · 不兼容 418 · 待定 200 · 未测 23 · 监测 703 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2353）— 可用 783 · 不兼容 346 · 待定 176 · 未测 14 · 监测 1034 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（753）— 可用 249 · 不兼容 140 · 待定 51 · 未测 6 · 监测 307 — [明细](catalog/all/消息通讯.md)
- **🗂 文件数据**（704）— 可用 266 · 不兼容 110 · 待定 63 · 未测 9 · 监测 256 — [明细](catalog/all/文件数据.md)
- **🎮 娱乐生活**（461）— 可用 170 · 不兼容 47 · 待定 25 · 未测 0 · 监测 219 — [明细](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1392）— 可用 422 · 不兼容 164 · 待定 120 · 未测 7 · 监测 679 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（167）— 可用 34 · 不兼容 15 · 待定 7 · 未测 2 · 监测 109 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7546）— 可用 1825 · 不兼容 436 · 待定 258 · 未测 23 · 监测 5004 — [明细](catalog/all/其他.md)
...
> 渲染于快照 20260922T071501Z（2026-09-22 15:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）
...
| 运行级实测 | 8390 可用 · 3331 不兼容 · 1817 待定（共 13538 个，k8s agent 口径）|

...
[![confirmed](https://img.shields.io/badge/confirmed-1205-blue)](#精选插件榜) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#当前生态快照) [![tested](https://img.shields.io/badge/tested-13354-orange)](#本仓库如何判定) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=zh)](https://dshfind.com/zh/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![运行级可用](https://img.shields.io/badge/运行级可用_8878-0.1.1--rc.2-brightgreen)](#2-看懂状态统一四档口径) [![待测](https://img.shields.io/badge/待测_1659-0.1.1--rc.2-lightgrey)](#2-看懂状态统一四档口径) [![需适配](https://img.shields.io/badge/需适配_2942-0.1.1--rc.2-yellow)](#2-看懂状态统一四档口径)
...
> 数据截至快照 `20260913T210001Z`（2026-09-14 05:00:03 UTC+8 · 分类器 unified-v2-bridge）

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["发现（每 6 小时 · probe 每 15 分钟 巡检触发）"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>候选 20738 · 龄 211m"]
        A2["本地库补全 · 去重 repo id"]
    ...
    B1 -->|"插件 1205"| C1["k8s 运行级测试<br/>一插件一 pod · 并发 10<br/>dsh agent + Qwen（de-stream）"]
    B1 -->|"非插件（累计删 0）"| B3["即删省空间"]
    C1 --> D1{"判定 · 总 13354"}
    D1 -->|"8878 / 2942"| E1["聚合 + README 分类统计"]
    D1 -->|"1534 环境类重试"| C1
...
- **🔌 Web UI 增强**（2773）— 可用 1340 · 不兼容 415 · 待定 240 · 未测 17 · 监测 761 — [明细](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2155）— 可用 911 · 不兼容 365 · 待定 197 · 未测 21 · 监测 661 — [明细](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2268）— 可用 809 · 不兼容 288 · 待定 172 · 未测 13 · 监测 986 — [明细](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（722）— 可用 256 · 不兼容 119 · 待定 57 · 未测 5 · 监测 285 — [明细](catalog/all/消息通讯.md)
...
- **🛠 基建部署**（1365）— 可用 443 · 不兼容 131 · 待定 131 · 未测 6 · 监测 654 — [明细](catalog/all/基建部署.md)
- **📚 学习研究**（158）— 可用 38 · 不兼容 8 · 待定 8 · 未测 2 · 监测 102 — [明细](catalog/all/学习研究.md)
- **❓ 其他**（7238）— 可用 1832 · 不兼容 380 · 待定 251 · 未测 21 · 监测 4754 — [明细](catalog/all/其他.md)
...
> [!NOTE]
> **测试版本**：dsh（容器内 agent）+ Qwen3.6-35B 驱动（经 de-stream 代理）· k8s 5 分片 · 以快照 `run_id` 锚定具体轮次（当前 `20260913T210001Z`）。DSH 的 npm 版本号未随快照记录，以 run_id 与 `reports/agent-test/` 日期交叉核对。

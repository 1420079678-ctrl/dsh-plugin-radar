...
[![confirmed](https://img.shields.io/badge/confirmed-1256-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-13357-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8880-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1669-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2933-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1256 plugin repos indexed** (manifest-level classification, v2 engine), **13357 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260913T223002Z` (2026-09-14 06:30:05 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 20777 · age 74m"]
    ...
    B1 -->|"plugins 1256"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 0)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 13357"}
    D1 -->|"8880 / 2933"| E1["aggregate + README stats"]
    D1 -->|"1544 env retries"| C1
...
- **🎓 技能包**（30）— OK 7 · incompatible 2 · pending 6 · untested 12 · watching 3 — [details](catalog/all/技能包.md)
- **🧠 记忆增强**（47）— OK 15 · incompatible 5 · pending 4 · untested 2 · watching 21 — [details](catalog/all/记忆增强.md)
- **🎨 主题皮肤**（23）— OK 10 · incompatible 1 · pending 2 · untested 7 · watching 3 — [details](catalog/all/主题皮肤.md)
- **🛒 市场与管理**（315）— OK 102 · incompatible 20 · pending 18 · untested 10 · watching 165 — [details](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（2776）— OK 1341 · incompatible 415 · pending 242 · untested 17 · watching 761 — [details](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2153）— OK 910 · incompatible 364 · pending 197 · untested 21 · watching 661 — [details](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2269）— OK 808 · incompatible 286 · pending 176 · untested 13 · watching 986 — [details](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（723）— OK 256 · incompatible 119 · pending 58 · untested 5 · watching 285 — [details](catalog/all/消息通讯.md)
- **🗂 文件数据**（674）— OK 267 · incompatible 95 · pending 57 · untested 9 · watching 246 — [details](catalog/all/文件数据.md)
- **🎮 娱乐生活**（455）— OK 171 · incompatible 37 · pending 32 · untested 0 · watching 215 — [details](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1364）— OK 442 · incompatible 131 · pending 131 · untested 6 · watching 654 — [details](catalog/all/基建部署.md)
- **📚 学习研究**（158）— OK 38 · incompatible 8 · pending 8 · untested 2 · watching 102 — [details](catalog/all/学习研究.md)
- **❓ 其他**（7238）— OK 1830 · incompatible 382 · pending 250 · untested 21 · watching 4755 — [details](catalog/all/其他.md)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260913T223002Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260913T223002Z（2026-09-14 06:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8880 可用 · 2933 不兼容 · 1544 待定（共 13357 个，k8s agent 口径）|

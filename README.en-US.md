...
[![confirmed](https://img.shields.io/badge/confirmed-1256-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-13417-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8918-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1680-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2944-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1256 plugin repos indexed** (manifest-level classification, v2 engine), **13417 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260914T213002Z` (2026-09-15 05:30:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 21094 · age 13m"]
    ...
    C1 --> D1{"verdict · total 13417"}
    D1 -->|"8918 / 2944"| E1["aggregate + README stats"]
    D1 -->|"1555 env retries"| C1
...
- **🔌 Web UI 增强**（2772）— OK 1335 · incompatible 416 · pending 241 · untested 17 · watching 763 — [details](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2156）— OK 911 · incompatible 364 · pending 199 · untested 21 · watching 661 — [details](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2288）— OK 821 · incompatible 288 · pending 178 · untested 13 · watching 988 — [details](catalog/all/Agent%20能力.md)
...
- **🎮 娱乐生活**（457）— OK 173 · incompatible 36 · pending 33 · untested 0 · watching 215 — [details](catalog/all/娱乐生活.md)
...
- **❓ 其他**（7283）— OK 1861 · incompatible 384 · pending 252 · untested 21 · watching 4765 — [details](catalog/all/其他.md)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260914T213002Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260914T213002Z（2026-09-15 05:30 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8918 可用 · 2944 不兼容 · 1555 待定（共 13417 个，k8s agent 口径）|

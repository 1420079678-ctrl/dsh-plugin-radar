...
[![confirmed](https://img.shields.io/badge/confirmed-1289-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-13420-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8919-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1681-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2945-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1289 plugin repos indexed** (manifest-level classification, v2 engine), **13420 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260914T221501Z` (2026-09-15 06:15:02 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 21094 · age 57m"]
    ...
    B1 -->|"plugins 1289"| C1["k8s runtime test<br/>1 pod per plugin · concurrency 10<br/>dsh agent + Qwen (de-stream)"]
    B1 -->|"non-plugins (dropped 0)"| B3["dropped to save space"]
    C1 --> D1{"verdict · total 13420"}
    D1 -->|"8919 / 2945"| E1["aggregate + README stats"]
    D1 -->|"1556 env retries"| C1
...
- **🛒 市场与管理**（316）— OK 102 · incompatible 21 · pending 18 · untested 10 · watching 165 — [details](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（2773）— OK 1336 · incompatible 415 · pending 242 · untested 17 · watching 763 — [details](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2157）— OK 912 · incompatible 363 · pending 200 · untested 21 · watching 661 — [details](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2288）— OK 818 · incompatible 291 · pending 178 · untested 13 · watching 988 — [details](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（727）— OK 256 · incompatible 120 · pending 58 · untested 5 · watching 288 — [details](catalog/all/消息通讯.md)
- **🗂 文件数据**（686）— OK 278 · incompatible 95 · pending 58 · untested 9 · watching 246 — [details](catalog/all/文件数据.md)
- **🎮 娱乐生活**（457）— OK 172 · incompatible 36 · pending 34 · untested 0 · watching 215 — [details](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1370）— OK 445 · incompatible 131 · pending 132 · untested 6 · watching 656 — [details](catalog/all/基建部署.md)
- **📚 学习研究**（159）— OK 39 · incompatible 8 · pending 8 · untested 2 · watching 102 — [details](catalog/all/学习研究.md)
- **❓ 其他**（7284）— OK 1864 · incompatible 383 · pending 251 · untested 21 · watching 4765 — [details](catalog/all/其他.md)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260914T221501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260914T221501Z（2026-09-15 06:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8919 可用 · 2945 不兼容 · 1556 待定（共 13420 个，k8s agent 口径）|

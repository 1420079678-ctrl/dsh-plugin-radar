...
[![confirmed](https://img.shields.io/badge/confirmed-1256-blue)](#featured) [![scan](https://img.shields.io/badge/scan-every_6h-green)](#ecosystem-snapshot) [![tested](https://img.shields.io/badge/tested-13404-orange)](#how-we-assess-compatibility) [![dshfind](https://dshfind.com/api/badge/AdamPlatin123/dsh-plugin-radar?lang=en)](https://dshfind.com/plugins/AdamPlatin123/dsh-plugin-radar?ref=badge) [![license](https://img.shields.io/badge/license-MIT-blue)](LICENSE)

[![runtime OK](https://img.shields.io/badge/runtime_OK_8910-0.1.1--rc.2-brightgreen)](#2-understand-status-unified-4-tier-scale) [![to test](https://img.shields.io/badge/to_test_1678-0.1.1--rc.2-lightgrey)](#2-understand-status-unified-4-tier-scale) [![needs adapt](https://img.shields.io/badge/needs_adapt_2941-0.1.1--rc.2-yellow)](#2-understand-status-unified-4-tier-scale)

[English](README.en-US.md) | [简体中文](README.md)

---

**What is this?** DeepSeek Harness (DSH) is an open-source coding agent where everything is a plugin. This repo is a **radar** that automatically tracks its plugin ecosystem — **1256 plugin repos indexed** (manifest-level classification, v2 engine), **13404 runtime-tested on the k8s track**.
...
> Data as of snapshot `20260914T211501Z` (2026-09-15 05:15:03 UTC+8 · classifier unified-v2-bridge)

<!-- AUTO:pipeline:START -->
```mermaid
flowchart TB
    subgraph Discovery["Discovery (every 6h · probe every 15 min)"]
        A1["GitHub Search<br/>topic ×2 + keyword ×3<br/>candidates 21080 · age 224m"]
    ...
    C1 --> D1{"verdict · total 13404"}
    D1 -->|"8910 / 2941"| E1["aggregate + README stats"]
...
- **🎨 主题皮肤**（23）— OK 11 · incompatible 0 · pending 2 · untested 7 · watching 3 — [details](catalog/all/主题皮肤.md)
- **🛒 市场与管理**（316）— OK 102 · incompatible 21 · pending 18 · untested 10 · watching 165 — [details](catalog/all/市场与管理.md)
- **🔌 Web UI 增强**（2774）— OK 1337 · incompatible 417 · pending 240 · untested 17 · watching 763 — [details](catalog/all/Web%20UI%20增强.md)
- **💻 编码开发**（2154）— OK 911 · incompatible 362 · pending 199 · untested 21 · watching 661 — [details](catalog/all/编码开发.md)
- **🤖 Agent 能力**（2287）— OK 819 · incompatible 289 · pending 178 · untested 13 · watching 988 — [details](catalog/all/Agent%20能力.md)
- **📡 消息通讯**（726）— OK 255 · incompatible 120 · pending 58 · untested 5 · watching 288 — [details](catalog/all/消息通讯.md)
- **🗂 文件数据**（682）— OK 274 · incompatible 95 · pending 58 · untested 9 · watching 246 — [details](catalog/all/文件数据.md)
- **🎮 娱乐生活**（457）— OK 173 · incompatible 36 · pending 33 · untested 0 · watching 215 — [details](catalog/all/娱乐生活.md)
- **🛠 基建部署**（1370）— OK 445 · incompatible 132 · pending 131 · untested 6 · watching 656 — [details](catalog/all/基建部署.md)
- **📚 学习研究**（159）— OK 39 · incompatible 8 · pending 8 · untested 2 · watching 102 — [details](catalog/all/学习研究.md)
- **❓ 其他**（7275）— OK 1858 · incompatible 384 · pending 252 · untested 21 · watching 4760 — [details](catalog/all/其他.md)
...
> [!NOTE]
> **Test version**: dsh (in-container agent) driven by Qwen3.6-35B (via the de-stream proxy) · k8s, 5 shards · each run is anchored by the snapshot `run_id` (currently `20260914T211501Z`). The DSH npm version is not recorded per snapshot — cross-check via run_id and the `reports/agent-test/` dates.
...
> 渲染于快照 20260914T211501Z（2026-09-15 05:15 UTC+8）· 数据源 data/snapshots/（渲染即对齐）

| 证据层 | 当前结果 |
|---|---:|
| 自动收录 全量索引 2943 · 收录（克隆验证）2996 · 当前版本（0.1.1-rc.2）已测 345 个仓库 |
| 运行级实测 | 8910 可用 · 2941 不兼容 · 1553 待定（共 13404 个，k8s agent 口径）|

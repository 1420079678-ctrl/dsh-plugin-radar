...
- 🟩 `[可用]` [stakeswky-awesome-dsh](https://github.com/stakeswky/awesome-dsh) ★1 — DSH 插件生态导航：GitHub topic dsh-plugin 全量目录，自动抓取 + Workers AI 中文翻译 + 按需检索 skill｜Auto-updating catalog of 2600+ Dee
